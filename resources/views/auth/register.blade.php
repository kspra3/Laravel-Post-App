    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="date_of_birth" type="date" name="date_of_birth" class="mt-1 block w-full" wire:model.defer="date_of_birth" />
            </div>

            <div class="mt-4">
                <x-jet-label for="mailing_address" value="{{ __('Mailing Address') }}" />
                <x-jet-input id="mailing_address" class="block mt-1 w-full" type="text" name="mailing_address" required />
            </div>
